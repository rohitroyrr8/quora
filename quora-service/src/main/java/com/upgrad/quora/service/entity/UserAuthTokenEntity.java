...
@NamedQueries({
        ...
        @NamedQuery(name = "userAuthToke-nByAccessTokenAndLogout", query = "select ut from UserAuthTokenEntity ut where ut.accessToken = :accessToken AND ut.logoutAt != null ")
})
